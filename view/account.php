...
$accDebit = viewAccountDebit();
$accKredit = viewAccountKredit();
$i = 1;
 ?>
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form action="../controller/ctlraccount.php" method="post" name="data" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div id="type" class="btn-group" data-toggle="buttons">
                            <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="type" value="debit" id="type"> &nbsp; Debit &nbsp;
                            </label>
                            <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="type" value="kredit" id="type"> Kredit
                            </label>
                          </div>
                        </div>
                      </div>
          ...
          <!-- datatable or debit data  -->
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>Debit Table <small></small></h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    if($accDebit == FALSE){
                      ...
                      while($rowDebit = $accDebit->fetch_assoc()) {
                        ?>
                        <tr>
                          <td><?= $i?></td>
                          <td><?= $rowDebit['title']; ?></td>
                          <td><?= $rowDebit['amount']; ?></td>
                          <td><?= $rowDebit['date']; ?></td>
                        </tr>
                        <?php
                        $i++; }
          ...
          <!-- datatable for kredit view -->
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>Credit Table <small></small></h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                <p class="text-muted font-13 m-b-30">
                  ...
                  <tbody>
                    ...
                    if($accKredit == FALSE){
                      ...
                      while($rowKredit = $accKredit->fetch_assoc()) {
                        ?>
                        <tr>
                          <td><?= $i?></td>
                          <td><?= $rowKredit['title']; ?></td>
                          <td><?= $rowKredit['amount']; ?></td>
                          <td><?= $rowKredit['date']; ?></td>
                        </tr>
                        <?php
                        $i++; }
                      }
